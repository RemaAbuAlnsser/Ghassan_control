...
export default function StoreFooter() {
  ...
  return (
    <footer className="site-footer" id="footer">
      ...
      {(settings.whatsapp || settings.facebookUrl || settings.instagramUrl || settings.tiktokUrl) && (
